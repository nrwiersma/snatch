...
func TestParser_ParseCanParseValidMetrics(t *testing.T) {
	metrics := [][]byte{
		[]byte("lvl=info msg= count#test=2 foo=\"bar\" size=10"),
		[]byte("lvl=info msg= count#test@0.1=2 foo=\"bar\" size=10"),
		[]byte("lvl=info msg= count#test=-2 foo=\"bar\" size=10"),
		[]byte("lvl=info msg= count#test@0.1=-2 foo=\"bar\" size=10"),
		[]byte("lvl=info msg= sample#test=2.3 foo=\"bar\" size=10"),
		[]byte("lvl=info msg= sample#test@0.1=2.3 foo=\"bar\" size=10"),
		[]byte("lvl=info msg= measure#test=2.3ms foo=\"bar\" size=10"),
		[]byte("lvl=info msg= measure#test@0.1=2.3ms foo=\"bar\" size=10"),
	}
...
func TestParser_ParseHandlesTags(t *testing.T) {
	m := []byte("lvl=info msg= count#test=2 foo=\"bar\" size=10 test=test")
	p := snatch.NewParser(time.Second)
...
func BenchmarkParser_Parse(b *testing.B) {
	m := []byte("lvl=info msg= count#test@0.1=2ms foo=\"bar\" size=10")
	p := snatch.NewParser(time.Second)
